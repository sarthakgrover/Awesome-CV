...
%---------------------------------------------------------
  \cventry
    {Assistant Manager and Freelance Researcher} % Job title
    {Sugandhaa Co., Ltd.} % Organization
    {New Delhi, INDIA} % Location
    {Apr. 2018 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
      \item {Leading a family-owned business. Responsible for inventory, account management, conducting sales, and delivery services.}
